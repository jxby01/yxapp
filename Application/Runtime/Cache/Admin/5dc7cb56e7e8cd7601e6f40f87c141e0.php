<?php if (!defined('THINK_PATH')) exit();?>
          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <?php if(is_array($news)): foreach($news as $key=>$val): ?><tr>
                  <td><input type="checkbox" name="checkname[]" value="<?php echo ($val['news_id']); ?>" /></td>
    ...
    <script type="text/javascript">
      ...
      function sort(){
        ...
        // console.log(data);
        $.ajax({
          url:"<?php echo U('NewsLogic/news_sort');?>",
          type:"post",
          data:{
            data:data
          },
      ...
      $('.shanc').click(function(){
        ...
        layer.confirm('是否删除该条新闻栏目信息？', {
          ...
          $.ajax({
                  url:"<?php echo U('NewsLogic/news_del');?>",
                  type:"post",
                  data:{
                    news_id:id
                  },
      ...
      if(str==''){
        ...
        layer.confirm('是否删除选中新闻栏目信息？', {
          ...
          $.ajax({
                  url:"<?php echo U('NewsLogic/news_alldel');?>",
                  type:"post",
                  data:{
                    id:str
                  },
