			...
			<div class="content">
				<div class="card-box">
					...
					<div class="am-g">
						...
						<form action="<?php echo U('Admin/Diary/diary');?>" method="post" enctype="multipart/form-data">
...
<!--	                	<div class="am-btn am-btn-xs am-text-secondary youxiuriji <?php echo $v['home_page']==0?di:'';?> <?php echo $v['excellent']==0?tjdaoshouy:quxiaotuijian;?>"  title="点击改变状态" data-id="<?php echo ($v["id"]); ?>" data-ex="<?php echo ($v["excellent"]); ?>">优秀日记</div> -->
	                </td>
	                <td>
	                  <div class="am-btn-toolbar">
	                    <div class="am-btn-group am-btn-group-xs">
